...
(defun make-comparsions-list (fields)
  (loop while fields
     collecting (make-comparsion-expr (pop fields) (pop fields))))

(defmacro where (&rest clauses)
  `#'(lambda (cd)
       (and ,@(make-comparsions-list clauses))))

;; (macroexpand-1 '(where :title "Give Us a Break" :ripped nil))
(defun test-function (&key (a 1) (b 2))
  (list a b))
